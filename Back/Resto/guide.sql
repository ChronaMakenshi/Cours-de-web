...
--
-- Hôte : 127.0.0.1:3306
-- Généré le :  mar. 05 fév. 2019 à 14:14
...
(2, 'La Marinade', '54, chemin des Amarantes 44000 Nantes', 26, 'Excellents poissons. Service convenable. Cave bien fournie', 14, '18/05/2008'),
...
(9, 'Le Vefour', '12, rue Champollion 75002 Paris', 30, 'Une bonne table à la cuisine toujours bien exécutée', 13, '08/01/2001'),
(10, 'La Grande Bouffe', '18, rue des Goinfres 75017 Paris', 25, 'Une nourriture basique, histoire de se remplir la pense entre amis', 11, '05/02/2019'),
(12, 'Le Napoli', '25, rue des Navarins', 50, 'Excellent plats Italiens de tradition. Cadre agréable.', 15, '15/02/2019');
COMMIT;
