...
{
  private $db = 'cvtheque'; //nom de la base de données
  ...
  public function __construct()
  {
  	try 
  	{
  		$this->dsn = "mysql:dbname=$this->db;host=$this->host;port=3308";
  ...
  // Destructeur de la classe qui permet de fermer la connexion à la BDD
  ...
  public function suppression_enreg($id)
  {
    ...
    $resultat = $this->reqSelection("delete from personne where id=".$id);
