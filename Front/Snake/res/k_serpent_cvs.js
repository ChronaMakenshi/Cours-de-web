...
function serpent_bouge(evt){	//deplacement du serpent et du corps.

	if(k_serpent.direction==39){ // Touche Clavier droit
	...
	if(k_serpent.direction==37){ // Touche Clavier gauche
	...
	if(k_serpent.direction==38){ // Touche Clavier haut
	...
	if(k_serpent.direction==40){ // Touche Clavier bas
	...
	for(var i = 1; i < k_serpent.tb_el; i++){
		...
		if(colision_queue(i)){
			...
			k_serpent.aud=k_serpent.creason('res/son/FinPartie');
	...
	if(colision()){
		...
		document.getElementById('point').innerHTML="Score : "+k_serpent.point;
...
function posi_pom(){	//nouvelle position de la pomme générée de façon aléatoire dans la grille 
	// des valeurs possibles [0,..,12000[ pour x et [0, .., 8000[ pour y.
...
function fin(){	// fin de partie; on vide les tableaux, arrete l'interval et affiche le menu.
	...
	document.getElementById('bestpoint').innerHTML ="Meilleur Score : "+localStorage.score;
...
function init_serpent(){
	...
	if(localStorage.score === undefined){ 
	 	document.getElementById('bestpoint').innerHTML ="Meilleur Score : "+0;
	}else{
		document.getElementById('bestpoint').innerHTML ="Meilleur Score : "+localStorage.score;
	}
	...
	k_serpent.tete.src='res/tete6.png';
	k_serpent.tete.onload = function(){

		k_serpent.corp = new Image();
		k_serpent.corp.src='res/serpent2.png';
	...
	k_serpent.aud=k_serpent.creason('res/son/PowerUp');
