...
--
-- Hôte : 127.0.0.1:3308
-- Généré le :  mer. 23 déc. 2020 à 10:59
...
CREATE TABLE IF NOT EXISTS `entcom` (
  ...
  `OBSCOM` varchar(25) CHARACTER SET latin1 COLLATE latin1_general_ci DEFAULT NULL,
  PRIMARY KEY (`NUMCOM`),
  KEY `FK_ENTCOM_FOURNIS` (`NUMFOU`)
) ENGINE=InnoDB AUTO_INCREMENT=70631 DEFAULT CHARSET=latin1 COLLATE=latin1_general_ci;
...
(70630, '120', '2021-01-05 10:38:44', 'Dernière minute');
...
CREATE TABLE IF NOT EXISTS `fournis` (
  ...
  `NOMFOU` varchar(30) CHARACTER SET latin1 COLLATE latin1_general_ci NOT NULL,
  `RUEFOU` varchar(30) CHARACTER SET latin1 COLLATE latin1_general_ci NOT NULL,
  `POSFOU` varchar(5) CHARACTER SET latin1 COLLATE latin1_general_ci NOT NULL,
  `VILFOU` varchar(25) CHARACTER SET latin1 COLLATE latin1_general_ci NOT NULL,
  `CONFOU` varchar(15) CHARACTER SET latin1 COLLATE latin1_general_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS `ligcom` (
  ...
  `CODART` char(4) CHARACTER SET latin1 COLLATE latin1_general_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS `produit` (
  `CODART` char(4) CHARACTER SET latin1 COLLATE latin1_general_ci NOT NULL,
  `LIBART` varchar(25) CHARACTER SET latin1 COLLATE latin1_general_ci NOT NULL,
  `STKALE` decimal(7,0) NOT NULL,
  `STKPHY` decimal(7,0) NOT NULL,
  `QTEANN` decimal(7,0) NOT NULL,
  `UNIMES` char(5) CHARACTER SET latin1 COLLATE latin1_general_ci NOT NULL,
  PRIMARY KEY (`CODART`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_general_ci;
